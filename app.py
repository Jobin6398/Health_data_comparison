...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('POSTGRES_URL', 'postgres://neondb_owner:npg_NjOli29xpdkR@ep-rapid-smoke-adxlql80-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require')
